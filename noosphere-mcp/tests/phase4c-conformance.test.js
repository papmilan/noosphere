...
const CONFORMANCE = Object.freeze({
  ...
  'crash recovery reachability': {
    ...
    evidence: [
      ...
      ['tests/restore-recovery-cli.test.js', 'converges a SIGKILL at ${boundary} before a new apply after owner lock removal'],
  ...
  'recovery lock policy': {
    ...
    evidence: [
      ...
      ['tests/restore-recovery-cli.test.js', 'leaves a competitor lock untouched after the owner clears a stale lock'],
      ['tests/restore-recovery-cli.test.js', 'refuses a lock held by a live process without modifying it'],
